...
ZLIB_VERSION=1.2.13
ZLIB_CLOUDFLARE_VERSION=8856740
...
NGX_ECHO_VERSION=8376edc2bbc427e8812d105f4061045449e0db2b
...
fetch_source "echo-nginx-module-${NGX_ECHO_VERSION}" "$NGX_ECHO_URL"
CONFIGURE_ARGS="$CONFIGURE_ARGS --add-module=../echo-nginx-module-${NGX_ECHO_VERSION}"
